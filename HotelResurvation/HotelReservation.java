package com.BridgeLabz.HotelResurvation;
...
public class HotelReservation implements HotelReservationIF {
    ...
    public ArrayList<Hotel> getHotelList1(){
        return hotelList;
    }
    public int noOfWeekends1(LocalDate startDate, LocalDate endDate) {
        int weekends = 0;
    ...
    public String getCheapestHotel1(LocalDate startDate, LocalDate endDate,String customerType) {
        ...
        try {
            if(custType.length() == 0) {
                ...
                int weekends = noOfWeekends1(startDate,endDate);
    ...
    public String getBestRatedHotel1(LocalDate startDate, LocalDate endDate) {
        int rate=0;
